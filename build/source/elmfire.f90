...
INTEGER :: COLOR, I, IASP, IBAND, IBIN, ICASE, ICASE_RECV, ICOL, IDEST=0, IERR=0, IOS, &
           ...
           NTIMESTEPS, TOTALCASESRUN, IWX_MEM_BAND, DONE_CASES

INTEGER, ALLOCATABLE, DIMENSION(:) :: K, rank_per_case
...
CHARACTER(60) :: VERSIONSTRING='ELMFIRE 2026.0130.memopt'
...
IF (MODE .NE. 2) THEN
   ...
   DO WHILE (DONE_CASES .LT. NUM_CASES_TOTAL)
      DO i = 1, NPROC
         ...
         ICASE = i*NPROC + IRANK_WORLD + DONE_CASES
         if (ICASE .gt. NUM_CASES_TOTAL) IS_VIRTUAL_RUN = .TRUE.
