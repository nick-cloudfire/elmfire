...
INTEGER :: I, TEMP_SX, TEMP_SY, DEL_X, DEL_Y, IX_LOW_BORDER, IY_LOW_BORDER, IX_HIGH_BORDER, IY_HIGH_BORDER, &
           IX_TEMP, IY_TEMP, HAZ, WTU_DIST_LIMIT
REAL, INTENT(IN) :: T
REAL :: TARGET_R, TARGET_R_METERS, TARGET_THETA, WIND_THETA, TARGET_THETA_F, MAX_ELLIPSE_DIST, ELLIPSE_DIST_THETA, &
        ...
        DFC_HEAT_FLUX, RAD_HEAT_FLUX, DFC_SIGMOID, RAD_SIGMOID, HRR_ADJUSTER, WTU_FLIN_LIMIT, ADJUSTER_COEFF   !DWI_M1
...
DO I = 1, SIZE(INDEX_FILTERED)
      ...
      ADJUSTER_COEFF = LB_P%ELLIPSE_PARAMETERS%ELLIPSE_MINOR/LB_P%ELLIPSE_PARAMETERS%ELLIPSE_MAJOR
      ...
      HRR_ADJUSTER = ANALYSIS_CELLSIZE_SQUARED/(PI*ADJUSTER_COEFF*LB_P%ELLIPSE_PARAMETERS%ELLIPSE_MAJOR*LB_P%ELLIPSE_PARAMETERS%ELLIPSE_MINOR)  !DWI_M2
