...
IF (IRANK_WORLD .EQ. 0 .AND. READ_ALREADY_BURNED) CALL READ_BSQ_RASTER (ALREADY_BURNED, OUTPUTS_DIRECTORY, ALREADY_BURNED_FILENAME, 1, 1)
IF (IRANK_WORLD .EQ. 0 .AND. READ_PHI) CALL READ_BSQ_RASTER (PHI, OUTPUTS_DIRECTORY, PHI_FILENAME, 1, 1)
