...
USE_TILED_IO, USE_BARRIERS, WEATHER_DIRECTORY, WS_AT_10M, VRT_INSTEAD_OF_TIF, SDI_FILENAME, TIMED_LOCATIONS_CSV, ONLY_READ_NEEDED_WX_BANDS
...
DUMP_BINARY_OUTPUTS, DUMP_CROWN_FIRE, DUMP_EMBER_FLUX, DUMP_CROWN_FIRE_AREA, DUMP_EMITIMES, &
...
WSMFEFF_LOW_MULT, WX_BILINEAR_INTERPOLATION, WX_BANDS_KEPT_IN_MEM
